...
function App() {
  ...
  return (
    <div className="app">
      ...
      {/* Menu Overlay (full screen scrim, panel only left 480px) */}
      {menuOpen && (
        <div className="menu-overlay" onClick={() => setMenuOpen(false)}>
          ...
          >
            ...
            <div className="menu-logo-icon">
              <img src="/ELSEWHERE - Kokopelli Logo.svg" alt="Kokopelli" />
            </div>
          </div>
        </div>
      )}
        ...
        <div className="content-page">
          ...
          <div className="page-content">
            ...
            <p>
              ...
              These rooms will be a place for enjoyment, for great listening
              experiences, for musical inspiration and for new friends to meet
          ...
          <div className="upload-layout">
            <div className="upload-text">
              ...
              <ul>
                ...
                <li>
                  You can record on any equipment that uses a thumb drive as its
                  source. The only reason for this is that we need to know that
                  you can play on any equipment provided at an event.
                </li>
            ...
            <div className="upload-form">
              <form action="https://formspree.io/f/mzzwdyye" method="POST">
                ...
                <input
                  name="mix_url"
                  type="url"
                  placeholder="Mix URL (SoundCloud, Mixcloud, etc.)"
                  required
                />
                <input
                  name="location"
